...
# Gobiiformes families — ordered by descending species count
set_order = ['high-Gobiidae', 'low-Gobiidae', 'diff-Gobiidae',
             'high-Eleotridae', 'low-Eleotridae', 'diff-Eleotridae',
             'high-Odontobutidae', 'low-Odontobutidae', 'diff-Odontobutidae'] ### order in plot
